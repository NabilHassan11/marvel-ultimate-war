...
public abstract class Champion implements Damageable,Comparable {
	...
	public String toString(){
		...
		sb.append("Name: "+name+'\n');
		sb.append("Max HP: "+maxHP+'\n');
		sb.append("Current HP: "+currentHP+'\n');
		sb.append("Mana: "+mana+'\n');
		sb.append("Max Action Points: "+maxActionPointsPerTurn+'\n');
		sb.append("Current Action Points: "+currentActionPoints+'\n');
	...
	public String displayAbilities2() {
		String result = "\n\nAbilities: ";
		String type ="";
		for(Ability a : abilities) {
			...
			result+= "\nName: " + a.getName() +"\nType: " + type + "\nArea of Effect: " + a.getCastArea().toString() 
					+ "\nMana Cost: " + a.getManaCost() + "\nCast Range: " + a.getCastRange()
					+"\nCurrent Base Cooldown: " + a.getCurrentCooldown() + "\n";
